    ...
    <el-tab-pane label="通用">
      <el-form>
        ...
        <el-form-item label="显示单词">
          <el-switch v-model="baseSettingStore.word" inline-prompt size="small"/>
        </el-form-item>
        <el-form-item label="单词假名">
          <el-switch v-model="baseSettingStore.kana" inline-prompt size="small"/>
        </el-form-item>
        <el-form-item label="单词释义">
          <el-switch v-model="baseSettingStore.wordDesc" inline-prompt size="small"/>
        </el-form-item>
      </el-form>
    </el-tab-pane>
    <el-tab-pane label="语音">
      <el-form>
        <el-form-item label="音频朗读">
          <el-switch v-model="baseSettingStore.audioSpeak" inline-prompt size="small"/>
        </el-form-item>

        <el-form-item label="TTS语音朗读">
          <el-switch v-model="baseSettingStore.ttsSpeak" inline-prompt size="small"/>
        </el-form-item>
