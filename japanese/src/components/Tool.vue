          ...
          <el-form-item label="-">
            <div class="item-group">
              ...
              <el-button v-if="baseSettingStore.ttsSpeak && hiraganaResult" size="small" class="speak-button"
                         :disabled="speechStore.isSpeaking" @click="speechStore.speak(hiraganaResult)">
                <el-icon>
      ...
      <el-tab-pane label="日文朗读">
        <div class="text-speak-pane">
          ...
          <div class="text-speak-button-group">
            <el-button size="small" @click="speechStore.speak(textToSpeak)"
                       :disabled="speechStore.isSpeaking">朗读
            </el-button>
            <el-button size="small" type="warning" @click="speechStore.stop"
                       v-if="speechStore.isSpeaking">终止
            </el-button>
            <el-button size="small" type="danger" @click="onSpeakTextClear"
                       v-if="textToSpeak">清空
            </el-button>
          </div>
        </div>
